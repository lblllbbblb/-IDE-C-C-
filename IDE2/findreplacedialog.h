...
#include <QHBoxLayout>
#include <QVBoxLayout>
#include <QTextEdit> // 需要访问 QTextEdit 来执行查找和替换操作
...
public:
    // 构造函数，需要一个父窗口和一个 QTextEdit 指针，以便操作文本
    explicit FindReplaceDialog(QTextEdit *textEdit, QWidget *parent = nullptr);
...
private:
    QTextEdit *m_textEdit;  // 指向主窗口的 QTextEdit 控件
